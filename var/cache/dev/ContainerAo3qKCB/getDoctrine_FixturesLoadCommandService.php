...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'AdminFixture.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AdminFixture(($container->services['.container.private.security.password_encoder'] ?? $container->load('get_Container_Private_Security_PasswordEncoderService'))), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []]]);
